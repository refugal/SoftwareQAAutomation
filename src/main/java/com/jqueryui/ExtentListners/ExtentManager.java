package com.jqueryui.ExtentListners;
...
import com.jqueryui.PageObjects.*;
...
public class ExtentManager {
    ...
    public synchronized static ExtentReports getReporter() {
        if (extent == null) {
	        ...
	        extent.setSystemInfo("Automation Tester", "Lakhan Singla");
	        extent.setSystemInfo("Build no", "SoftwareQA-1234");
        }
        return extent;
    }
